...
CREATE TABLE securities (
    ...
    symbol TEXT,
    name TEXT NOT NULL,
    asset_class TEXT NOT NULL CHECK (asset_class IN ('etf', 'stock', 'bond', 'fund', 'commodity', 'derivative')),
    currency TEXT NOT NULL DEFAULT 'EUR',
    ter NUMERIC(6,4),
...
CREATE TABLE transactions (
    ...
    date DATE NOT NULL,
    type TEXT NOT NULL CHECK (type IN ('buy', 'sell', 'dividend', 'interest', 'deposit', 'withdrawal', 'fee', 'transfer', 'savings_plan', 'tax')),
